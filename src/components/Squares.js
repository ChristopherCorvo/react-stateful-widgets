...
export default function Squares() {
  ...
  const [squareIds, setsquareIds] = useState(listOfSquareIds)  // array
  const [ActiveSquareId, setActiveSquareId] = useState (null) //index in the array
  ...
  // so the value of 'activeSquare' should be null. --Done--
